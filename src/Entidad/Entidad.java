...
public class Entidad {
    ...
    public void dibujar(Graphics2D g2){
        ...
        switch (direccion){
            case "arriba":
                if(spriteNumero ==1){imagen = arriba1;}
                if(spriteNumero == 2){imagen = arriba2;}
                break;
            case "abajo":
                if(spriteNumero ==1){imagen = abajo1;}
                if(spriteNumero == 2){imagen = abajo2;}
                break;
            case "derecha":
                if(spriteNumero ==1){imagen = derecha1;}
                if(spriteNumero == 2){imagen = derecha2;}
                break;
            case "izquierda":
                if(spriteNumero ==1){imagen = izquierda1;}
                if(spriteNumero == 2){imagen = izquierda2;}
                break;
        }
